...
def train_ale_environment():
    ...
    # Create a DQN agent
    agent = DQNAgent(network, environment, log_dir="./train/breakout/dqn_breakout")
...
def performance_test(epsilon=0.02):
    ...
    log_dir = "./thi_test/dqn_test/"
    model_path = "./train/dqn_breakout_time_based_30_40_02-04-2018-18-18"
    model_names = []
