...
class Module(object):
    ...
    def __init__(self, name, device=None, summary_labels=None, l2_regularization=None):
        ...
        # print('\nModule --> init()')
        # print('\tparent', self.parent, 'scope', self.scope, 'name', name, 'device', device,
        #       'labels', summary_labels, 'l2_reg', l2_regularization)
        ...
        # print('\tname', self.name, 'device', self.device, 'summary_labels', self.summary_labels)
        # print('\tglobal_scope', Module.global_scope, Module.global_tensors, Module.global_tensors_spec)
    ...
    def create_api_function(self, name, api_function):
        #print('\nModule --> create_api_function()', name, api_function)
        ...
        # print('\tfn', fn)
        # print('Module <-- create_api_function()\n')
        return fn
