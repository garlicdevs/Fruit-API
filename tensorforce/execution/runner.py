...
class Runner(object):
    ...
    def run_episode(self, environment, max_timesteps, evaluation):
        ...
        print('\tepisode_timeste', self.episode_timestep)
        print('\tepisode updated', self.episode_updated)
        print('\tepside agent second', self.episode_agent_second)
        print('\ttimesteps', self.timesteps)
        print('\tepsiodes', self.episodes)
        print('\tupdates', self.updates)
        print('Runner <-- run_episode()\n')
