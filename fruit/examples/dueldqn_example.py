...
from fruit.networks.config.atari import AtariDuelDQNConfig
...
def train_ale_environment():
    ...
    agent = DQNAgent(network, environment, save_time_based=30, checkpoint_stop=40, log_dir="./train/Pong/dueldqn_pong_time_based_30_40")
...
def eval_ale_environment(model_path, render, num_of_epochs, steps_per_epoch, initial_epsilon, log_dir):
    ...
    # Create DQN agent (Duel DQN can use DQN agent)
...
def performance_test(epsilon=0.02):
    ...
    log_dir = "./thi_test/dueldqn_test/"
    model_path = "./train/dueldqn_breakout_time_based_30_40_02-06-2018-11-30"
    model_names = []
