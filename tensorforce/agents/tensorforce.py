...
class TensorforceAgent(Agent):
    ...
    def __init__(
        ...
        # print('\nTensorForce --> init()')
        # print('\tupdate', update, 'objective', objective, 'reward_estimation', reward_estimation)
        # print('\tpolicy', policy, 'memory', memory, 'optimizer', optimizer)
        # print('\tbaseline_policy', baseline_policy, 'baseline_optimizer', baseline_optimizer, 'baseline_objective', baseline_objective)
        # print('\texploration', exploration, 'variable_noise', variable_noise, 'l2_reg', l2_regularization, 'entroy_re', entropy_regularization)
        # print('\tname', name, 'device', device, 'parallel_interactions', parallel_interactions, 'buffer_observe', buffer_observe,
        #       'seed', seed, execution, saver, summarizer, recorder, config)
        ...
        #print('\treward_estimation', reward_estimation)
        #print('\texperience_size', self.experience_size)
