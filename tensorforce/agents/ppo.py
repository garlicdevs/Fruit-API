...
class ProximalPolicyOptimization(TensorforceAgent):
    ...
    def __init__(
        ...
        print('\tStates, action, max_eps_ts', states, actions, max_episode_timesteps)
        print('\tNetwork', network)
        print('\tBatch size', batch_size)
        print('\tUpdate frequency', update_frequency, 'learning rate', learning_rate, 'subsampling frac',
              subsampling_fraction)
        print('\tlikelyhood_ratio_clipping', likelihood_ratio_clipping, 'discount', discount, 'estimate_terminal',
              estimate_terminal)
        print('\tcritic_network', critic_network, 'critic_optimizer', critic_optimizer)
        print('\tmemory', memory)
        print('\tpreprocessing', preprocessing)
        print('\texloration', exploration)
        print('\tvariable noise', variable_noise)
        print('\tl2_regulization', l2_regularization, 'entroy_regularization', entropy_regularization)
        print('\tname', name, 'device', device, 'parallel interations', parallel_interactions, 'seed', seed, 'exe',
        ...
        print('\tupdate', update, update_frequency)
        ...
        print('\treward_estimation', reward_estimation)
        print('\tbaseline_policy', baseline_policy)
        print('\tcritic optimizer', critic_optimizer)
        print('\tbaseline_objective', baseline_objective)
